        ...
        function renderPesanan(data) {
            ...
            Object.values(data).forEach((user) => {
                var konfirmasiPembayaran = `
                            ...
                            `;
                var openDetail = `
                                <a class="dropdown-item" href='<?= base_url('kasir/cart/') ?>${user['id_ses']}'><i class='fa fa-trash'></i>Open</a>
                            `;
                var button = `
                            ...
                            `;
                renderData.push([user['waktu'], statusPesanan(user['ses_status']), user['nama_meja'], user['nama_pemesan'], user['total_qyt'], convertToRupiah(user['total_harga']), button]);
            });
